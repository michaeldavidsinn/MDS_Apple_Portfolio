...
export const ProjectCard = ({
  ...
  const hasModalDetail = typeof detail === "object" && detail.isModal;
      ...
      <motion.div className={styles.container} variants={cardVariants}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.links}>
            {hasModalDetail ? (
              <button onClick={() => setIsModalOpen(true)} className={styles.demoBtn}>
                View Details
              </button>
            ) : (
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          <div className={styles.lightboxOverlay} onClick={() => setSelectedImage(null)}>
            <button className={styles.lightboxCloseBtn} onClick={() => setSelectedImage(null)}>×</button>
            <motion.img 
              src={selectedImage} 
              alt="Enlarged view" 
